...
!!! 注意
    ...
    原始站点：[FightTheLandlord#C++版本](https://wiki.botzone.org.cn/index.php?title=FightTheLandlord#C.2B.2B.E7.89.88.E6.9C.AC)

本地编译方法请参见[JSONCPP](https://wiki.botzone.org.cn/index.php?title=JSONCPP)。

为了解决clang编译问题，C++样例在2018年4月30日进行了一次更新，更新内容是给`CardCombo.CardPack.operator<()`函数后面加上`const`。

5月7日，样例又进行了一次更新，修复了若干bug，具体修改可以[点此查看](https://wiki.botzone.org/index.php?title=FightTheLandlord&type=revision&diff=696&oldid=695)。

5月8日修正了`cardComboScore`和`ComboType`不对应的问题。可以[点此查看](https://wiki.botzone.org/index.php?title=FightTheLandlord&type=revision&diff=697&oldid=696)。
